                        ...
                        <div class="col-lg-6">
                            <div class="card-body p-md-4 mx-md-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <h4 class="mt-1 mb-5 pb-1">Enregistrement d'un nouveau Responsable Pedagogique</h4>
                                </div>
                                ...
                                <form>
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="email" id="form2Example11" class="form-control"
                                               placeholder="yourename@email.com" />
                                    ...
                                    <div class="form-outline mb-4">
                                        <input type="password" id="form2Example22" class="form-control" placeholder="confirm your password"/>
